...
You can file new issues by providing the above information [here](https://github.com/angular/preboot/issues/new).

### <a name="submit-pr"></a> Submitting a Pull Request (PR)
Before you submit your Pull Request (PR) consider the following guidelines:

* Search [GitHub](https://github.com/angular/preboot/pulls) for an open or closed PR
...
[github]: https://github.com/angular/preboot
[gitter]: https://gitter.im/angular/preboot
