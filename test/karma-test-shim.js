...
/** Runs the Preboot specs in Karma. */
function runSpecs() {
...
/** Whether the specified file is part of Preboot. */
 ...
 * each unit test.
 *
 * Without this patch, the combination of two behaviors is problematic for Preboot:
